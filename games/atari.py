...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Replay Buffer
        self.replay_buffer_size = int(1e6)  # Number of self-play games to keep in the replay buffer FIXME: Is this our problem? If the replay buffer is only in ram, this may be fucking us over.
